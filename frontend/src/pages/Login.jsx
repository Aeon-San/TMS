                    ...
                    <div className="flex items-center justify-center px-4 py-8 sm:px-10 sm:py-10 lg:px-16">
                        <div className="w-full max-w-md">
                            <div className="mb-8 text-center sm:mb-10">
                                <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Login</h1>
                            </div>
                            ...
                            <form onSubmit={handleLogin} className="space-y-5">
                                ...
                                <div className="text-right">
                                    <Link to="/forgot-password" className="text-sm font-medium text-[#d79b43] transition hover:text-[#c7821a]">
                                        Forgot Password?
                                    </Link>
                                </div>
                                ...
                                <p className="pt-3 text-center text-sm text-slate-600">
                                    ...
                                    <Link to="/signup" className="font-semibold text-slate-800 underline decoration-[#ff7b86] underline-offset-4">
                                        Sign Up here
                                    </Link>
                                </p>
                            </form>
